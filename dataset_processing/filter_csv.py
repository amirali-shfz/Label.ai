...
labels.to_csv('csv/filtered/labels2.csv', index=False)
images.to_csv('csv/filtered/images2.csv', index=False)
classes.to_csv('csv/filtered/classifications2.csv', index=False)
