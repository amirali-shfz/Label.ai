  ...
  get: async (path: string) => {
    ...
    switch (trimmed) {
          ...
          prompt: [
            {
              ...
              labels: [
                {
                  label_id: randomString(),
                  label_name: randomString(),
                  class_id: randomString(),
                },
              ],
            },
          ],
      ...
      case "/labels/all":
        return returnPromise({
          labels: [
            { label_id: "1", label_name: "label 1" },
            { label_id: "2", label_name: "label 2" },
            { label_id: "3", label_name: "label 3" },
          ],
        });
      case "/images/confirmed":
        return returnPromise({
          images: [
            {
              url: "https://c7.staticflickr.com/1/35/70594660_499be9e349_o.jpg",
            },
            {
              url:
                "https://c5.staticflickr.com/9/8185/8121565107_718c80b0ef_o.jpg",
      ...
      case "/images/underclassified":
        return returnPromise({
          images: [
            {
              url:
                "https://c3.staticflickr.com/7/6028/5956647590_bee0e724af_o.jpg",
            ...
            {
              url:
                "https://c2.staticflickr.com/5/4031/4505653924_4fe8a59bf9_o.jpg",
            ...
            {
              url:
                "https://farm6.staticflickr.com/13/16383286_2e1b11206a_o.jpg",
            ...
            {
              url:
                "https://c7.staticflickr.com/3/2682/4232861778_0f91c7273a_o.jpg",
