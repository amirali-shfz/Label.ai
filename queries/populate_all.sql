...
INSERT INTO member(username, password, trust, name) VALUES
    ('wbhildeb', '1092745', 0.5, 'Walker'),
    ('kfeng', '1289501', 0.75, 'Kevin'),
    ('super_trust', '2145312', 10, 'God'),
    ('no_trust', '12380', 0, 'TrollMan42069');

INSERT INTO submission(class_id, member_id, correct_label) VALUES
    (3, 1, False), (2, 2, False), (12, 1, False), (14, 2, False), (9, 3, True), (10, 2, True), (1, 3, True), (3, 1, True), (1, 1, False), (7, 3, False), (14, 2, False), (11, 1, True), (5, 2, True), (7, 2, True), (4, 2, True), (6, 3, True), (14, 3, True), (13, 2, True), (9, 3, True), (11, 3, False), (12, 1, False), (11, 1, False), (8, 3, True), (8, 2, True), (13, 2, True), (8, 2, False), (7, 1, True), (13, 3, False), (10, 3, False), (4, 2, False);